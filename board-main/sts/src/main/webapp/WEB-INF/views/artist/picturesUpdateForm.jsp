...
<body>
    <div id="writeBody">
        <form action="/artist/updatePicture?picture_idx=${detailPicture.picture_idx}" method="post"
            ...
            <input type="hidden" name="artist_idx" value="${detailPicture.artist_idx}">
            <div id="board-catetory">
                <p>작품 수정</p>
            </div>
            <div>
                <label>작품명 : </label><input type="text" id="picture_title" name="picture_title"
                    value="${detailPicture.picture_title}">
            </div>
            <div>
                <label>작품 size : </label><input type="text" id="picture_size" name="picture_size"
                    value="${detailPicture.picture_size}">
            </div>
            <div>
                <label>작품 재료 : </label><input type="text" id="picture_supplies" name="picture_supplies"
                    value="${detailPicture.picture_supplies}">
            </div>
            <div>
