...
<body>
    <div id="writeBody">
        <form action="/artist/update?artist_idx=${detailArtist.artist_idx}" method="post" enctype="multipart/form-data">
            ...
            <div>
                <label>작가명 : </label><input type="text" id="artist_name" name="artist_name"
                    value="${detailArtist.artist_name}">
            </div>
            <div>
